...
class MaskRCNN(FasterRCNN):
    ...
    Example::
        ...
        >>> import torch
        >>> import torchvision
        >>> from torchvision.models.mixed_detection import MaskRCNN
        >>> from torchvision.models.mixed_detection.anchor_utils import AnchorGenerator
        >>>
...
def maskrcnn_resnet50_fpn(pretrained_coco=False, progress=True,
    ...
    Example::
        ...
        >>> model = torchvision.models.mixed_detection.maskrcnn_resnet50_fpn(pretrained=True)
        >>> model.eval()
        >>> x = [torch.rand(3, 300, 400), torch.rand(3, 500, 400)]
        >>> predictions = model(x)
        >>>
    ...
    backbone = resnet_fpn_backbone('resnet50', pretrained_imagenet_backbone=True,
