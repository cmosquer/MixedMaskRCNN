...
class FasterRCNN(GeneralizedRCNN):
    ...
    Example::
        ...
        >>> import torch
        >>> import torchvision
        >>> from torchvision.models.mixed_detection import FasterRCNN
        >>> from torchvision.models.mixed_detection.rpn import AnchorGenerator
...
def fasterrcnn_resnet50_fpn(pretrained_coco=False, progress=True,
    ...
    Example::
        ...
        >>> model = torchvision.models.mixed_detection.fasterrcnn_resnet50_fpn(pretrained=True)
        >>> # For training
...
def fasterrcnn_mobilenet_v3_large_320_fpn(pretrained=False, progress=True, num_classes=91, pretrained_backbone=True,
    ...
    Example::
        ...
        >>> model = torchvision.models.mixed_detection.fasterrcnn_mobilenet_v3_large_320_fpn(pretrained=True)
        >>> model.eval()
        >>> x = [torch.rand(3, 300, 400), torch.rand(3, 500, 400)]
        >>> predictions = model(x)
...
def fasterrcnn_mobilenet_v3_large_fpn(pretrained=False, progress=True, num_classes=91, pretrained_backbone=True,
    ...
    Example::
        ...
        >>> model = torchvision.models.mixed_detection.fasterrcnn_mobilenet_v3_large_fpn(pretrained=True)
        >>> model.eval()
        >>> x = [torch.rand(3, 300, 400), torch.rand(3, 500, 400)]
        >>> predictions = model(x)
